...
一个以可爱粽子角色为品牌形象、面向低龄儿童的益智学习 Web App。项目规划为数字、字母、单词三类内容，目前完成数字类的「数字排排队」和「谁不见了？」两个小游戏。

## 当前玩法

- 首页用三个独立入口展示数字、字母、单词三大类，游戏页面不再占用空间显示分类导航。
- 数字乐园内展示两个小游戏入口；字母和单词入口暂时展示预告页。
...
- 两个游戏在 Pad 横竖屏下均完整容纳于一屏，操作过程中无需上下滚动。
